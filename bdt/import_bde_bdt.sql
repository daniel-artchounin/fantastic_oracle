...
ANALYZE TABLE ro_f_bdt_catalogue COMPUTE STATISTICS;
ANALYZE TABLE ro_f_bdt_magasin COMPUTE STATISTICS;
ANALYZE TABLE ro_f_bdt_date COMPUTE STATISTICS;
ANALYZE TABLE ro_f_bdt_vente COMPUTE STATISTICS;